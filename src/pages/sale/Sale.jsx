...
const Sale = ({ simplified }) => {
  const { estatesForSale, loading, displayFilter } = useGlobalContext();
        ...
        <div className="container">
          {simplified && (
            <div className="banner-section flex flex-row justify-center space-x-2">
              <div className="banner-covers shadow-2xl shadow-white"></div>
